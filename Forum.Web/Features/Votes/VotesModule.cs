// Forum.Web/Features/Votes/VotesModule.cs
...
/// <summary>
/// Registers the client-side Votes slice: the typed HttpClient for the API's
/// vote endpoints, wired with the shared AuthTokenHandler so cast/clear carry the
/// bearer token.
/// </summary>
public static class VotesModule
{
    public static IServiceCollection AddVotesFeature(this IServiceCollection services, IConfiguration config)
    {
        ...
        services.AddHttpClient<IVoteApiClient, VoteApiClient>(client =>
        {
